...
n<- list.files(pattern="tre")
setwd("/Users/josue/Dropbox/1Doutorado/Chapter_2/biodiverse_pipeline-master")
##########################################################################################################

for (i in 1:99){
input_tree_file <- paste0("/Users/josue/Dropbox/1Doutorado/Chapter_2/biodiverse_pipeline-master/trees_separate/",n[i])
...
#
#source("/Users/josue/Downloads/biodiverse_pipeline-master/R_release/biodiverse_path_reference.R")

...
##########################################################################################################
#
csv_file <- paste0("/Users/josue/Dropbox/1Doutorado/Chapter_2/biodiverse_pipeline-master/snakes_gridded_dist_epsg_3577.csv")
...
label_column_number <- 3 #column number that the label is in
group_column_number_x <- 8 #column number that the x group is in
group_column_number_y <- 9 #column number that the y group is in
